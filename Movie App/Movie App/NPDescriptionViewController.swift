//
//  NPDescriptionViewController.swift
//  Movie App
//
...
// Controller for the movie description view when a movie in the NowPlayingTableview is selected

class NPDescriptionViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        print("NP Description ViewDidLoad")
